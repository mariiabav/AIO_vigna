...
def train():
    ...
    data_images, data_labels = load_images_from_folder(
        '/Users/andrejbavykin/PycharmProjects/vigna_flowering/AIO_summer')
    ...
    data_vector = to_categorical(data_labels, 11)
    ...
    for tr, valid in kfold.split(train_images, train_labels):
        ...
        print(
            f'Score for fold {fold_no}: {best_model.metrics_names[0]} of {scores[0]}; {best_model.metrics_names[1]} of {scores[1] * 100}%')
